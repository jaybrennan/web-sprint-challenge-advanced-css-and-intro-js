...
function get20s(array){
  ...
  for (let i = 0; i < array.length; i++){
    let yearBorn = parseInt((array[i].years).substring(0,4));
    let yearDied = parseInt((array[i].years).substring(7,11));
    if (( yearBorn > 1900) && (2000 > yearDied)){
...
function addArtist(array){
  const newArtist = {
    ...
    bio: "James was born in the United States of America on Thursday, December 26th of 1991. Fun Fact: James' birthday is on the same day of the dissolution of the Soviet Union."
  }
